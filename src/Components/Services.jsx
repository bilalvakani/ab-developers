...
//         <CoursesCard img={web} title="Web Development" content="  We build modern, responsive websites tailored to your needs. Whether it's a 
//   sleek portfolio, an interactive educational site, or a professional corporate 
//   website, our designs focus on performance, usability, and impact." />
//         <CoursesCard img={appImg} title="App Development" content=" Transform your ideas into powerful mobile or web applications. Our apps are 
//   user-friendly, feature-rich, and designed to meet your unique business goals, 
//   ensuring an exceptional user experience." />
//         <CoursesCard img='https://s14308.pcdn.co/wp-content/uploads/2023/07/hero-static.jpg.optimal.jpg' title="Wordpress Development "content=" Get beautifully designed, customizable WordPress websites. From blogs to 
//   eCommerce stores, we deliver scalable solutions that are easy to manage and 
